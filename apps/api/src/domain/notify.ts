...
export async function notify(
  ...
  body: string, opts: { marketId?: string; commentId?: string; groupId?: string } = {},
): Promise<void> {
  await c.query(
    `INSERT INTO notifications (user_id, kind, market_id, comment_id, group_id, body)
     VALUES ($1,$2,$3,$4,$5,$6)`,
    [userId, kind, opts.marketId ?? null, opts.commentId ?? null, opts.groupId ?? null, body],
  );
}
